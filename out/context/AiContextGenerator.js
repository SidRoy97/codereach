...
class AiContextGenerator {
    ...
    async generate() {
        ...
        vscode.window.showInformationMessage(`CodeSec: ${OUTPUT_FILENAME} generated. Commit this file — Claude Code, Cursor, Gemini, and Copilot all read it automatically.`);
    }
    ...
    detectAndDescribePatterns(root) {
        const lines = [];
